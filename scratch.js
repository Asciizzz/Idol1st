...
// CSS Rules
const c_body = addNode("c_body", "CSS_RULE", "body", -300, -200, { selector: "body", code: "margin: 0;\nfont-family: 'Quicksand', sans-serif;\nbackground: #fff0f5;\ncolor: #4a4a4a;\noverflow-x: hidden;", collapsed: true });
const c_nav = addNode("c_nav", "CSS_RULE", "nav", -600, -200, { selector: "nav", code: "display: flex;\njustify-content: space-around;\nalign-items: center;\npadding: 15px 30px;\nbackground: #ff69b4;\nbox-shadow: 0 4px 15px rgba(255,105,180,0.4);\nposition: sticky;\ntop: 0;\nz-index: 100;", collapsed: true });
const c_logo = addNode("c_logo", "CSS_RULE", ".logo", -900, -200, { selector: ".logo", code: "font-size: 2rem;\nfont-weight: 800;\ncolor: #fff;\ntext-shadow: 2px 2px 0px #ff1493;", collapsed: true });
const c_nav_link = addNode("c_nav_link", "CSS_RULE", ".nav-link", -1200, -200, { selector: ".nav-link", code: "color: #fff;\ntext-decoration: none;\nfont-weight: bold;\nfont-size: 1.1rem;\ncursor: pointer;\ntransition: transform 0.2s, color 0.2s;", collapsed: true });
const c_nav_link_hov = addNode("c_nav_link_hov", "CSS_RULE", ".nav-link:hover", -1500, -200, { selector: ".nav-link:hover", code: "color: #ffe4e1;\ntransform: scale(1.1);", collapsed: true });
const c_hero = addNode("c_hero", "CSS_RULE", ".hero", -300, 0, { selector: ".hero", code: "display: flex;\nflex-direction: column;\nalign-items: center;\njustify-content: center;\nmin-height: 80vh;\ntext-align: center;\npadding: 40px;", collapsed: true });
const c_hero_title = addNode("c_hero_title", "CSS_RULE", ".hero h1", -600, 0, { selector: ".hero h1", code: "font-size: 4rem;\ncolor: #ff1493;\nmargin-bottom: 20px;\ntext-transform: uppercase;\nletter-spacing: 2px;", collapsed: true });
const c_hero_subtitle = addNode("c_hero_subtitle", "CSS_RULE", ".hero p", -900, 0, { selector: ".hero p", code: "font-size: 1.5rem;\ncolor: #ff69b4;\nmax-width: 600px;", collapsed: true });
const c_section = addNode("c_section", "CSS_RULE", "section", -1200, 0, { selector: "section", code: "padding: 60px 20px;\nmax-width: 1000px;\nmargin: 0 auto;", collapsed: true });
const c_card_grid = addNode("c_card_grid", "CSS_RULE", ".card-grid", -1500, 0, { selector: ".card-grid", code: "display: grid;\ngrid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\ngap: 30px;\nmargin-top: 40px;", collapsed: true });
const c_card = addNode("c_card", "CSS_RULE", ".card", -1800, 0, { selector: ".card", code: "background: #fff;\nborder-radius: 20px;\npadding: 20px;\nbox-shadow: 0 10px 30px rgba(255,105,180,0.15);\ntransition: transform 0.3s ease;\nborder: 2px solid #ffe4e1;", collapsed: true });
const c_card_hov = addNode("c_card_hov", "CSS_RULE", ".card:hover", -2100, 0, { selector: ".card:hover", code: "transform: translateY(-10px);\nborder-color: #ff69b4;", collapsed: true });
const c_btn = addNode("c_btn", "CSS_RULE", ".btn", -2400, 0, { selector: ".btn", code: "background: linear-gradient(45deg, #ff69b4, #ff1493);\ncolor: #fff;\npadding: 15px 40px;\nborder: none;\nborder-radius: 30px;\nfont-size: 1.2rem;\nfont-weight: bold;\ncursor: pointer;\nbox-shadow: 0 5px 15px rgba(255,20,147,0.3);\ntransition: all 0.3s ease;", collapsed: true });
const c_btn_hov = addNode("c_btn_hov", "CSS_RULE", ".btn:hover", -2700, 0, { selector: ".btn:hover", code: "transform: scale(1.05);\nbox-shadow: 0 8px 20px rgba(255,20,147,0.5);", collapsed: true });
const c_inline_img = addNode("c_inline_img", "CSS_RULE", "Image Style", -3000, 0, { selector: "", code: "width: 100%;\nmax-width: 400px;\nborder-radius: 50%;\nborder: 8px solid #ffe4e1;\nbox-shadow: 0 10px 30px rgba(255,105,180,0.3);\nmargin-top: 30px;\nobject-fit: cover;", collapsed: true });
const c_gallery_img = addNode("c_gallery_img", "CSS_RULE", "Gallery Image", -3300, 0, { selector: ".gallery-img", code: "width: 100%;\nheight: 200px;\nobject-fit: cover;\nborder-radius: 10px;\nmargin-bottom: 15px;", collapsed: true });
...
addEdge(c_btn_hov, c_inline_img, rootCss);
addEdge(c_inline_img, c_gallery_img, rootCss);
...
const idx_links = addNode("idx_links", "ELEMENT", "Nav Links", 600, -100, { tag: "div", attrsText: "style='display:flex; gap: 20px;'", text: "", collapsed: true });
...
// Nav (Duplicated structural for about)
...
const abt_links = addNode("abt_links", "ELEMENT", "Nav Links", 600, 650, { tag: "div", attrsText: "style='display:flex; gap: 20px;'", text: "", collapsed: true });
...
const abt_h1 = addNode("abt_h1", "ELEMENT", "About Title", 600, 800, { tag: "h1", attrsText: "style='color: #ff1493; text-align: center;'", text: "About Me", collapsed: false });
const abt_grid = addNode("abt_grid", "ELEMENT", "Lore Grid", 600, 950, { tag: "div", attrsText: "style='display: flex; gap: 30px; align-items: center; justify-content: center;'", text: "", collapsed: true });
addEdge(abt_sec, abt_h1, rootHtml2);
addEdge(abt_sec, abt_grid, rootHtml2);

const abt_img_el = addNode("abt_img_el", "ELEMENT", "Lore Image", 900, 850, { tag: "img", attrsText: "style='border-radius: 20px; max-width: 300px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);'", text: "", collapsed: true });
const abt_txt = addNode("abt_txt", "ELEMENT", "Lore Text", 900, 1050, { tag: "p", attrsText: "style='font-size: 1.2rem; line-height: 1.8;'", text: "[Replace this text with your VTuber lore. Tell your fans about your backstory, your goals, and what makes your streams unique!]", collapsed: false });
...
// Nav (Duplicated structural for gallery)
...
const gal_links = addNode("gal_links", "ELEMENT", "Nav Links", 600, 1450, { tag: "div", attrsText: "style='display:flex; gap: 20px;'", text: "", collapsed: true });
...
const gal_h1 = addNode("gal_h1", "ELEMENT", "Gallery Title", 600, 1600, { tag: "h1", attrsText: "style='color: #ff1493; text-align: center;'", text: "Media Gallery", collapsed: false });
...
for (let i = 1; i <= 3; i++) {
    const card = addNode("gal_card" + i, "ELEMENT", "Card " + i, 1200, 1700 + (i-1)*150, { tag: "div", attrsText: "class='card'", text: "", collapsed: true });
    addEdge(gal_grid, card, rootHtml3);
    
    const card_img = addNode("gal_cimg" + i, "ELEMENT", "Card Img " + i, 1500, 1700 + (i-1)*150, { tag: "img", attrsText: "class='gallery-img'", text: "", collapsed: true });
    const card_p = addNode("gal_cp" + i, "ELEMENT", "Card Text " + i, 1500, 1750 + (i-1)*150, { tag: "p", attrsText: "style='text-align:center; font-weight:bold; color: #ff69b4;'", text: "Stream Highlight " + i, collapsed: false });
    
    addEdge(card, card_img, rootHtml3);
    addEdge(card, card_p, rootHtml3);
    
    const card_asset = addNode("gal_asset" + i, "ASSET_IMAGE", "Screenshot " + i, 1800, 1700 + (i-1)*150, { url: "", filename: "Select Screenshot", collapsed: false });
